...
export function SiyaraTechFeatures() {
  const features = [
    {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-neutral-800 relative z-10 py-10 max-w-7xl mx-auto">
...
export default SiyaraTechFeatures;