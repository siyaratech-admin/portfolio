      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className="hidden px-6  z-[100] py-10 bg-neutral-100 max-w-[14rem] lg:w-fit  fixed lg:relative  h-screen left-0 lg:flex flex-col justify-between"
          >
